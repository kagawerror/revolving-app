...
/// Body of the profile tab/route: avatar, display name, role/company, appearance
/// controls, and sign-out. Owns the avatar capture + name-edit flows. Body-only
/// — both the [RoleShellScreen] (Profile tab) and the standalone [ProfileScreen]
/// (deep-link route) own the Scaffold + AppBar around it.
